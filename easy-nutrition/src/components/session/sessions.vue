...
import SessionService from '../../services/users-service';
  ...
  methods: {
    retrieveSessions() {
      SessionService.getAll()
          .then(response => {
            ...
            this.displaySessions = response.data.map(this.getDisplayUser);
          })
          .catch((e) => {
            console.log(e);
          });
    ...
    save() {
      if (this.editedIndex > -1) {
        ...
        this.displayUsers[this.editedIndex] = this.getDisplaySession(this.users[this.editedIndex]);
